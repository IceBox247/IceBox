    ...
    <div className="animate-fade-in space-y-6 px-5 pb-28 pt-2">
      ...
      <div className="card relative overflow-hidden p-5">
        ...
        <p className="mt-1 text-5xl font-extrabold">
          {usdt(data.perInvite)} <span className="text-2xl text-ice-300">ICE</span>
        </p>
      </div>
      ...
      {/* Earnings split: deposit commission (USDT) vs invite/task rewards (ICE) */}
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="card p-4">
          ...
          <div className="text-[11px] font-semibold text-white/40">ICE</div>
        </div>
      </div>
      ...
      <div className="card space-y-3 p-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <button
            onClick={() => {
              haptic('light');
              shareReferral(data.referralLink, '❄️ Join IceBox Wallet and earn ICE with me!');
            }}
      ...
      <div>
        ...
        <div className="mb-3 flex items-center justify-center gap-2 rounded-2xl border border-ice-400/20 bg-ice-400/10 px-4 py-3 text-sm font-bold text-ice-200">
          <TrophyIcon width={18} height={18} /> Top 100 referrers win ICE prizes
        </div>
          ...
          {data.leaderboard.map((row) => (
            ...
            >
              ...
              <div className="text-right">
                ...
                <p className="text-[10px] font-semibold text-white/40">ICE</p>
              </div>
            </div>
          ))}
        </div>
